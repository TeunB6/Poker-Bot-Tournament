...
from texasholdem import PlayerState, ActionType, TexasHoldEm
...
def format_game_state_dict(game: TexasHoldEm, history: str) -> dict:
    return {
        ...
        "at_stake": game.chips_at_stake(game.current_player),
